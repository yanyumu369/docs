  ...
  function (n, e, t) {
    ...
    const d = () => {
      const n = window.innerHeight,
        e = document.querySelectorAll("#main " + window.$docsify.toc.target);
      let t = [];
      e.forEach((e, o) => {
        ...
        function (n, e) {
          n.mounted(function () {
            ...
            if (n) {
              ...
              window.Docsify.dom.toggleClass(e, "add", "toc-nav"),
                window.Docsify.dom.before(n, e);
            }
          }),
            n.doneEach(function () {
